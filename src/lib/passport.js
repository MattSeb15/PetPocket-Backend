...
const { cifrarDatos, descifrarDatos } = require('../application/controller/encrypDates');

//archvios de coneccion
const orm = require('../infrastructure/Database/dataBase.orm');
const sql = require('../infrastructure//Database/dataBase.sql');
const mongo = require('../infrastructure//Database/dataBaseMongose')
